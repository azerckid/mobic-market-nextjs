...
const Bs = dynamic(
  ...
  { ssr: false, suspense: true, loading: () => <Skeleton /> }
);
...
const Enter: NextPage = () => {
  ...
  const { register: tokenRegiser, handleSubmit: tokenHandleSubmit } =
    useForm<TokenForm>();
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-3xl font-bold text-center">Enter to Mobic Market</h3>
      <div className="mt-12">
        {data?.ok ? (
          <form
